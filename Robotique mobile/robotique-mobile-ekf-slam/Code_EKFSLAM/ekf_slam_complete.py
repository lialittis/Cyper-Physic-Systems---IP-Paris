...
DT = 0.1  # time tick [s]
SIM_TIME = 160.0  # simulation time [s]
MAX_RANGE = 10.0  # maximum observation range
M_DIST_TH = 9  # Threshold of Mahalanobis distance for data association.
...
def main():
    ...
    # a dense map with many landmarks inside the robot perception radius (v = 1, w = 0.5)
    ...
    # a dense map with many landmarks all along the loop (v = 1, w = 0.1)
    # Landmarks = np.array([[3.0, 1.0],
    #                       [1.5, 0.5],
    #                       [5.5, 2.2],
    #                       [7.5, 3.2],
    #                       [8.0,14.1],
    ...
    # a sparse map with only few landmarks near the start position (trajectory v = 1, w = 0.1)
    # Landmarks = np.array([[0.0, 0.2],
    #                       [1.0, 0.0],
    #                       [0.3, 0.3]])


    # a sparse map with a large loop (v = 1, w = 0.1)
    Landmarks = np.array([[-10.0,1.0],
                          [0.0,19.0]])  
